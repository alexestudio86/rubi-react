...
export function GetAllProducts ( { posts } ) {
        ...
        <article key={index} className="col-md-6 p-2" >
          <div className='card p-2'>
            <div className='row'>
              ...
              <div className="col-md-9 bg-light d-block d-sm-non d-flex justify-content-between align-items-center">
                <h1 className='m-0 text-secondary fs-6 fw-bold'>{ post.title }</h1>
                <Link className="btn" to={ `./product/${post.id}` } >
