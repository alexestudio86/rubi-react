...
export function FooterCompact ( ){
    ...
    return (
        <div className={`bg-dark ${location.pathname !== '/' && 'fixed-bottom'}`} id='footerFull'>
            <div className='container py-2'>
                <div className='row'>
                    <div className='col-md-12 text-center'>By <Link to='.' className='link-primary'>Morita Creativa</Link></div>
                </div>
            </div>
        </div>
    )
